    ...
    <div class="box-border member-r">
        <div class="address-wrap">
            <div class="address-add">
                <a href="javascript:AddressOper('ismember','add')" class="btn btn-default btn-sm btn-big">新增收货地址</a>
                <span>您已创建 <b>1</b> 个收货地址，最多可建 <b>20</b> 个</span>
            </div>

                    <div class="address-info">
                        <button type="button" class="close" onclick="if(confirm('确认删除吗？')){AddressOper('1928994','del')}"><span>×</span></button>
                        <h5>zu</h5>
                        ...
                        <div class="operate">
                                默认&nbsp;<a href="javascript:AddressOper('1928994','edit')"><text>编辑</text> </a>
                        </div>
                    </div>
            <div class="address-add">
                <a href="javascript:AddressOper('ismember','add')" class="btn btn-default btn-sm btn-big">新增收货地址</a>
                ...
                <ul class="bd">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li class="active" id="addressListItem"><a href="https://www.hua.com/Member/AccountSetting/AddressList">常用收货人</a></li>
