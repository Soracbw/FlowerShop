...
<ul class="order-list">
                            ...
                            <li class="operate">
                                    <a href="https://www.hua.com/Member/Order/Detail?orderid=221194544&amp;pt=2018-04-27">查看</a><span>|</span><a href="javascript:OrderOper('221194544','cancel');"> 取消 </a>
                                    <a href="https://www.hua.com/Member/Payment/BalanceFill?orderid=221194544&amp;orderamount=667" class="btn btn-primary btn-sm">付款</a>
                            </li>
                        </ul>
<ul class="order-list">
                            <li class="img-box">
                            ...
                            <li class="state">待付款</li>
                            <li class="operate">
                                    <a href="https://www.hua.com/Member/Order/Detail?orderid=221148376&amp;pt=2018-04-27">查看</a><span>|</span><a href="javascript:OrderOper('221148376','cancel');"> 取消 </a>
                                    <a href="https://www.hua.com/Member/Payment/BalanceFill?orderid=221148376&amp;orderamount=189" class="btn btn-primary btn-sm">付款</a>
                            </li>
                        </ul>
                </div>
