...
<body class="home">
    ...
    <div class="site-nav">
        <div class="container">
            ...
            <ul class="site-nav-r">
                <!--登陆状态信息显示start-->
                <li class="menu login" id="LoginInfo">${sessionScope.admin}<a href="https://www.hua.com/Passport/Login/Loginout" title="退出">退出</a></li>
                <!--登陆状态信息显示end-->
...
系统管理员                </p>
            ...
            <div class="verify-mobile">
                    ...
                    <a class="btn btn-primary btn-sm" href="https://www.hua.com/member/accountsetting/editphoneauth">修改 <span class="glyphicon glyphicon-chevron-right"></span></a>
            </div>
        </div>
        ...
        <div class="member-panel">
            ...
            <div class="bd">
                    ...
                    <p align="center"></p><center><font color="red"><b>您好,您没有收藏的记录</b></font></center><p></p>
            </div>
        </div>
    </div>
</div>
