                                ...
                                <table border="0" cellpadding="0" cellspacing="4" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" height="50" width="85%">
                                            <input name="oldPwd" id="old_pass" value="" size="30" maxlength="40" type="password">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" height="50">
                                            <input name="newPwd1" id="new_pass1" value="" size="30" maxlength="40" type="password">
                                            <font color="#CC0000">*</font>&nbsp;&nbsp;<font color="#bbbbbbb">新密码要求由英文字母 (a-z大小写均可)、阿拉伯数字 (0-9) 组成且长度为6-16位字符。</font>                                               
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right" height="30">再次输入新密码：</td>
                                        <td align="left" height="50"><input name="newPwd2" id="new_pass2" value="" size="30" maxlength="40" type="password"> <font color="#CC0000">*</font></td>
                                    </tr>
                                    <tr>
                                        <td align="right" height="30"></td>
                                        <td align="left" height="50">
                                            <button type="submit" class="btn btn-default btn-sm btn-big">提交</button>
                                        </td>
                                    </tr>
                ...
                <ul class="bd">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li class="active" id="changePwdItem"><a href="https://www.hua.com/Member/AccountSetting/ChangePwd">修改密码</a></li>
