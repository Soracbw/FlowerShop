        ...
        <div class="box-border member-r">
            ...
            <div class="attention-list">
                        <ul class="attention-item">
                            ...
                            <li class="img-box">
                                <a href="https://www.hua.com/product/9012009.html"><img src="../assets/Images/9012009.jpg_80x87.jpg" alt="忘情巴黎-33枝红玫瑰，石竹梅围绕" width="150"></a>
                            </li>
                            ...
                            <li class="operate">
                                <a href="https://www.hua.com/Shopping/AddtoCart?product_code=9012009" class="btn btn-default btn-sm btn-m"><span class="ico ico-cart-m"></span>加入购物车</a>
                                <a href="https://www.hua.com/Member/Order/MyAttention?action=cancled&amp;product_code=9012009" onclick="return checkDelete();">取消收藏</a>
                            </li>
                        </ul>
            </div>
        </div>
                ...
                <ul class="bd">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li class="active" id="myAttentionItem"><a href="https://www.hua.com/Member/Order/MyAttention">我的收藏</a></li>
